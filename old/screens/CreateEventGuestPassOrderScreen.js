...
class CreateEventGuestPassOrderScreen extends React.Component {
  ...
  isGuestParking = () => {
    return this.state.selectedProject.projectName === "Art Residence" || this.state.selectedProject.projectName === "Manhattan";
  };
        ...
        <Animated.View
          ...
          <View
            ...
            <TouchableOpacity
              ...
              <Image
                style={styles.deleteGuest}
                source={index !== 0 ? Close : null}
              />
            </TouchableOpacity>
          </View>
          ...
          <TextField
            label="Фамилия"
            value={
              guests[index].surname !== undefined ? guests[index].surname : ""
            }
          ...
          <TextField
            label="Отчество"
            value={
              guests[index].patronymic !== undefined
                ? guests[index].patronymic
                : ""
            }
  ...
  onCheckResidense = ({ id }) => {
    const reselectedProject = this.state.projectList.find(
    ...
    if (reselectedProject.projectName !== "Manhattan" || reselectedProject.projectName !== "Art Residence") {
  ...
  checkCarData = (carData, isOnCar) =>
    isOnCar
      ? carData.plateNumber !== undefined && carData.plateNumber !== ""
      : true;
  ...
  onClickedSendButton = () => {
    const { isOnCar, selectedProject, date, guests, carData, comment } =
      this.state;
    const { setError, sendPass, navigation, setSuccess } = this.props;

    if (
      !this.checkNameContainsInGuests(guests) ||
      !this.checkCarData(carData, isOnCar)
    ) {
      setError([
        {
          message:
        ...
        <Animated.View
          ...
          <View style={{ width: "100%" }}>
            ...
            <View style={{ flexDirection: "row", flexWrap: "wrap", alignItems: "center" }}>
              ...
              />
              {this.isGuestParking() && <RoundButton
                style={{
                  width: 155,
      ...
      <View>
        <ScrollView
          ...
          <View style={[commonStyles.container, { paddingTop: 16 }]}>
            ...
            <ResidenceButton
              onPress={() =>
                navigation.navigate("ItemSelectionScreen", {
                  title: "Выбор проекта",
                  onItemSelected: this.onCheckResidense,
            ...
            {selectedProject.projectName !== "Tribeca Apartments" && <View style={styles.onCarWrapper}>
              <CheckBox
                label="На автомобиле"
                value={isOnCar}
          ...
          <View style={styles.modalMainView}>
            <View style={styles.topModalView}>
              ...
              <TouchableOpacity
                ...
                <Text style={{ color: "#747E90", marginRight: 20 }}>
                  Применить
                </Text>
              </TouchableOpacity>
            </View>
