...
class CreateEventLargeSizeDeliveryPassScreen extends React.Component {
  constructor(props) {
    super(props);
  ...
  render() {
    const { date, selectedProject, projectList, isShowLoader } = this.state;
...
})(CreateEventLargeSizeDeliveryPassScreen);
