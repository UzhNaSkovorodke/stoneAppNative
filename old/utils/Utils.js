...
import consts from "../constants/Uri";
...
export const getTime = () => {
  ...
  return moment(
    Math.ceil(moment().seconds(0).milliseconds(0) / interval) * interval,
  ).add(10, "minutes");
};
...
export const getRootImageUrl = () => {
  if (__DEV__) {
    return consts.rootImageDevUrl;
  }
  return consts.rootImageProdUrl;
};
